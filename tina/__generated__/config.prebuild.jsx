    ...
    collections: [
      ...
      // ── Industries Page ────────────────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          {
            type: "object",
            name: "overviewExpansion",
            label: "Expansion Industry Cards",
            list: true,
            fields: [
          ...
          {
            type: "object",
            name: "automotiveCards",
            label: "Automotive Feature Cards",
            list: true,
            fields: [
              { type: "string", name: "title", label: "Title" },
              { type: "string", name: "body", label: "Body", ui: { component: "textarea" } }
          ...
          {
            type: "object",
            name: "automotiveStats",
            label: "Automotive Stats",
            list: true,
            fields: [
          ...
          // Primary Sections (Healthcare, Electronics, Financial, Retail, Industrial)
          {
            ...
            label: "Primary Industry Sections",
            list: true,
            fields: [
          ...
          {
            type: "object",
            name: "expansionSections",
            label: "Expansion Industry Sections",
            list: true,
            fields: [
              { type: "string", name: "id", label: "Section ID (anchor)" },
          ...
          { type: "string", name: "crossBenefitsSubtext", label: "Cross-Benefits Subtext", ui: { component: "textarea" } },
          {
            type: "object",
            name: "crossBenefits",
            label: "Cross-Industry Benefit Cards",
            list: true,
            fields: [
              { type: "string", name: "iconName", label: "Icon Name (Lucide)" },
              { type: "string", name: "title", label: "Title" },
